class UserTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_type.save
        format.html { redirect_to @user_type, notice: t('flash.actions.create.notice') }
  ...
  def update
    respond_to do |format|
      if @user_type.update(user_type_params)
        format.html { redirect_to @user_type, notice: t('flash.actions.update.notice') }
  ...
  def destroy
    @user_type.destroy
    respond_to do |format|
      format.html { redirect_to user_types_url, notice: t('flash.actions.destroy.notice') }
