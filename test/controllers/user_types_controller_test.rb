...
class UserTypesControllerTest < ActionController::TestCase
  ...
  test "should create user_type" do
    assert_difference('UserType.count') do
      post :create, user_type: { allowance: @user_type.allowance, commissionPercentage: @user_type.commissionPercentage, description: @user_type.description, name: @user_type.name }
    end
  ...
  test "should update user_type" do
    patch :update, id: @user_type, user_type: { allowance: @user_type.allowance, commissionPercentage: @user_type.commissionPercentage, description: @user_type.description, name: @user_type.name }
    assert_redirected_to user_type_path(assigns(:user_type))
  end
